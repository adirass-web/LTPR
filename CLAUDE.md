# Site guide — cyberdrtabansky.com (for any AI edits)
...
## Fact-fidelity (do NOT overclaim)
- Singapore: authored the **vision, goals, and 70+ recommendations** behind the Strategy (NOT "authored the Strategy").
- World Bank: **World Bank-backed** critical-infrastructure resilience roadmaps across a dozen countries (NOT "ran a World Bank program").
- IAF: "elite Israel Air Force technology unit" (do not name the unit).
- *The National Interest* is his **byline**, not coverage - keep it in Writing, not the press wall.

## Legal
Press: outlet logos **linking to the original article**; fair-use thumbnails/pull-quotes only; never republish full clippings/PDFs.
